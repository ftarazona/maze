...
public class Dijkstra	{
	 ...
	 *  @param graph is the graph containing the vertices and
	 *   the distance between each couple.
	 *  @param root is the vertex of the graph which will be used
	 *   as the root of the output tree.
	 *  @param a is an empty set of vertices used to keep track of
	 *   which vertex has been visited.
	 *  @param pi is an empty Pi function.
	 *  @param prev is an empty Previous function.
	 *  @return None. The Pi and Previous functions must be
	 *   created before the method is called and are modified by
